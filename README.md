...
![the arrangement](./images/IMG_20240421_133525.jpg)
...
* στη συνέχεια στο block [_forever_], γίνεται μετάβαση από το radio group 1, στο radio group 5 και κατόπιν οι μεταβλητές μαζί με τις τιμές τους, αποστέλλονται για να τις λάβει ο τελευταίος μικροελεγκτής “παραλήπτης”.   
...
Στο τελικό στάδιο της λήψης των δεδομένων, το micro:bit  “παραλήπτης”, ο,τι λαμβάνει το στέλνει σε υπολογιστή, μέσω της θύρας USB  (Εικόνα 9). 
...
[![receive_and_serial_print](./images/receive_and_serial_print.png)](receive_and_serial_print.py)
...
Οι εντολές **serial write value (name) = (value)** στην Εικόνα 9 και **print(message)**  στην Εικόνα 10, στέλνουν τα δεδομένα στη θύρα USB υπολογιστή. Με το micro:bit συνδεδεμένο σε αυτή, μπορούμε να πάρουμε πληροφορίες όμοιες με εκείνες της Εικόνας 11, επιλέγοντας στο περιβάλλον makecode.microbit.org, το κουμπί **Show data Device**.
...
Το αρχείο που θα κατέβει στον υπολογιστή μας μπορούμε να το ανοίξουμε με μια εφαρμογή για υπολογιστικά φύλλα (Excel, LibreOffice).
