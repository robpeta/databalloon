...
i. 1 micro:bit για την αποστολή των δεδομένων (αποστολέας)
ii. 1 micro:bit edge connector, για την πρόσβαση στις επαφές του micro:bit
iii. 1 Αισθητήρα θερμοκρασίας και υγρασίας (dht11)
iv. 1 Αισθητήρα βαρομετρικής πίεσης και θερμοκρασίας (BMP280)
v. 1 Αντίσταση 10 ΚΩ
vi. 1 breadboard για τη σύνθεση των κυκλωμάτων
vii. αντίστοιχα καλώδια
viii.  1 μπαταριοθήκη με καλώδιο JST-PH για τροφοδοσία και δύο μπαταρίες ΑΑ
3. τους μικροελεγκτές για τη λήψη των δεδομένων:
i. 1 micro:bit για ενδιάμεση λήψη & αναμετάδοση δεδομένων (αναμεταδότης)
ii. 1 micro:bit για την τελική λήψη δεδομένων (παραλήπτης)
