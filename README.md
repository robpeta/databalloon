...
* στη συνέχεια στο block [_forever_], γίνεται μετάβαση από το radio group 1, στο radio group 5 και κατόπιν οι μεταβλητές μαζί με τις τιμές τους, αποστέλλονται στο τελικό μικροελεγκτή “παραλήπτη”.   
